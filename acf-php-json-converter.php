 ...
 * Plugin URI: https://github.com/kiunye/acf-php-json-converter
 ...
 */
define( 'ACF_PHP_JSON_CONVERTER_VERSION', '1.2.0' );
...
function run_acf_php_json_converter() {
	require_once ACF_PHP_JSON_CONVERTER_DIR . 'includes/Bootstrap.php';

	ACF_PHP_JSON_Converter\Bootstrap::instance()->init();
}
